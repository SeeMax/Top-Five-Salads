...
if (function_exists('acf_add_options_page')) {
    acf_add_options_page(array(
        'page_title'    => 'Top 5 Salads',
        'menu_title'    => 'Top 5 Salads',
        'menu_slug'    => 'top5_salads',
...
add_action('init', 'create_post_type');
 ...
 function wpb_change_title_text( $title ){
     ...
     if  ( 'salads' == $screen->post_type ) {
          $title = 'Enter That Salad Name';
     }
...
function custom_login_logo()
{
  echo '<style type="text/css">
      h1 a {
        background-image: url('.get_template_directory_uri().'/img/logo-admin.png) !important;
